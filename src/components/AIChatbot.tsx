      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-40 animate-scale-in">
          <ResizablePanelGroup
            ...
            className="min-w-[320px] max-w-[600px] min-h-[400px] max-h-[700px] rounded-lg border border-primary/20 bg-background/95 backdrop-blur-md shadow-2xl overflow-hidden"
          >
